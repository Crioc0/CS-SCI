...
- значительно быстрее
- стабильная организация памяти
- меньше нагрузки на сборщик мусора
- эффективное копирование данных

Минусы:

- больше потребление нативной памяти (вне heap JavaScript)
- работает только с числами
- операция resize остаётся дорогой
...
- заметно медленнее
- больше накладных расходов во время выполнения
- хуже локальность данных в памяти